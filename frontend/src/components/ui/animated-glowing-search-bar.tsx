  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        ...
        <div id="main" className="relative group scale-[0.70] origin-right">
          <input placeholder="Search Registry..." type="text" name="text" className="bg-[#010201] border-none w-[301px] h-[56px] rounded-lg text-white px-[59px] text-lg focus:outline-none placeholder-gray-400" />
